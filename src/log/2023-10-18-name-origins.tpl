...
(require "../log.tpl"
         "../fmt.tpl")
@log-entry[#:date "2023-10-18" #:updated "2023-10-19" #:title "name origins" #:desc "in which i tell some stories" #:mods (list mod-cens)]{
